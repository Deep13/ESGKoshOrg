...
const MaterialityAssessment = () => {
  ...
  return (
    <div className="flex flex-col w-full justify-between h-full items-center bg-white rounded-xl p-2">
        <div className="w-full flex justify-end">
            <select onChange={(e) => { setYear(e.target.value) }} className="border cursor-pointer rounded-xl border-[#29C472] px-3 py-2">
        ...
        <div className="w-full">
            <QuadrentChart series={chartData}/>
        </div>
    </div>
  )
}
